...
Copy-Item -Path (Join-Path $rootDir "engine\data\lexicon.bin") -Destination (Join-Path $dataDir "lexicon.bin") -Force
Copy-Item -Path (Join-Path $scriptDir "enable_tip.ps1") -Destination (Join-Path $toolsDir "enable_tip.ps1") -Force
Copy-Item -Path (Join-Path $scriptDir "disable_tip.ps1") -Destination (Join-Path $toolsDir "disable_tip.ps1") -Force
Copy-Item -Path (Join-Path $scriptDir "README.txt") -Destination (Join-Path $installDir "README.txt") -Force
